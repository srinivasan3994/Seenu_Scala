...
case class TAction(ActionId: Long, IntentID: Option[Long], EntityID: Option[Long], ActionName: Option[String], CallingInterval: Option[Long], WarningMessage: Option[String],  DataType: Option[String])
case class TActionExtn(ActionID: Long, WebhookUrl: String, RequestBody: Option[String], CallMethod: Option[String], SuccessCode: Option[String],
                       ErrorCode: Option[String], ResponsePath: Option[String], LocaleCode: Option[String])
...
case class TActionAuthorization(AAID: Long, AccessTokenUrl: Option[String], AccessTokenReqBody: Option[String], AccessTokenReqMethod: Option[String], AccessToken: Option[String], 
      ExpiryInterval: Option[Long], TokenCreatedTime: Option[String], UserAccessCode: Option[String])
...
case class TEntity(EntityID: Long, EntityName: Option[String], Example: Option[String], 
    EntityTypeCD: Option[String], DataType: Option[String]/*, ProjectID: Option[Long]*/)
...
case class TEntityRegex(EntityID: Long, RegexID: Long)
...
case class T_IMALSession(IMSessionID: Long, SessionID: String, IM_UserID: String, CreatedAT: String, ExpiredAT: Option[String], Reason: String, ChannelID: Option[Long])
...
case class TKnowledgeUnit(KUID: Long, KUName: String, ActiveIND: String, SpamEnable: String, IsRankable: Option[String])
...
case class TRegex(RegExID: Long, RegularExpression: String, ErrorMessage: Option[String])
...
case class TUserAttachemnts(AttachmentID: Long, IMLogID: Long, AttachmentType: String, AttachmentName: String, ChannelID: Long, EntityID: Long, IsDeleted: Option[String])
case class TUserMapping(MappingID: Long, IM_UserID: String, Backend_AccessCode: String, AcodeExpiry: Option[String],
...
case class TUserLocale(UserLocaleID: Long, UserID: String, ChannelID: Option[Long], LocaleCode: String)
case class TIntentMapping(IntentSeqID: Long, IntentID: Long, EntryType: String, EntryID: String, Order: Long, Required: Option[String], WorkFlowID: Option[Long])
case class TConversationCache(SessionID: String, IntentID: Long, EntryType: String, EntryID: String, CacheData: String, FullFilled: Option[String], ActionCacheData: Option[String])
...
case class TWorkFlowSequence(WorkFlowSeqID: Long, IntentID: Long, WorkFlowID: Long, WorkFlowSeqKey: String, EntryType: String,
                             EntryExpression: String, PmryDestWrkflwID: Option[Long], PmryDestSeqKey: Option[String], ScndryDestWrkflwID: Option[Long], 
                             ScndryDestSeqKey: Option[String], TerminalType: Option[String], Required: Option[String], InitialValidation: Option[String])
