...
*/
  /**
    ...
    *
    * This is useful for when you want to have child actors injected, and want
    * to pass parameters into them as well as have Guice provide some of the
    * parameters. It is intended to be used with Guice's AssistedInject feature.
    *
    ...
    * }}}
    *
    * So `db` should be injected, while `id` should be passed. Now, define a
    * trait that takes the id, and returns the actor:
    *
    * {{{
